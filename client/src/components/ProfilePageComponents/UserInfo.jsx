...
const UserInfo = props => {
    ...
    return (
        <div>
            ...
            <p><i className="fas fa-user-circle fa-fw w3-margin-right w3-large w3-text-indigo" /><a target="_blank" href={props.devContactInfo.portfolioURL}>{props.devContactInfo.portfolioURL}</a></p>
            <p><i className="fa fa-linkedin fa-fw w3-margin-right w3-large w3-text-indigo" /><a target="_blank" href={props.devContactInfo.linkedInURL}>{props.devContactInfo.linkedInURL}</a></p>
            <p><i className="fa fa-github fa-fw w3-margin-right w3-large w3-text-indigo" /><a target="_blank" href={props.devContactInfo.githubURL}>{props.devContactInfo.githubURL}</a></p>
